  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h1: ({...props }) => <h1 className="text-3xl font-bold mt-8 pb-2 mb-4 border-b border-gray-800 text-gray-200" {...props} />,
        h2: ({...props }) => <h2 className="text-2xl font-semibold mt-8 pb-2 mb-4 border-b border-gray-800 text-gray-200" {...props} />,
        h3: ({...props }) => <h3 className="text-xl font-semibold mt-6 mb-4 text-gray-200" {...props} />,
        h4: ({...props }) => <h4 className="text-lg font-semibold mt-6 mb-4 text-gray-200" {...props} />,
        p: ({...props }) => <p className="mb-4 text-gray-300 leading-relaxed" {...props} />,
        a: ({...props }) => <a className="text-blue-400 hover:text-blue-300 no-underline" {...props} />,
        ...
        img: ({ ...props }) => <img className="rounded-lg max-w-full my-4" {...props} alt="" />,
